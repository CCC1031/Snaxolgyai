        ...
        <div className="container space-y-12">
          ...
          <Tabs defaultValue="calculator" className="w-full">
            <TabsList className="grid grid-cols-2 md:grid-cols-4 w-full max-w-2xl mx-auto mb-8 bg-muted border-2 border-foreground/5 p-1 rounded-lg">
              ...
              <TabsTrigger value="scorecard" className="font-serif font-bold py-2.5 data-[state=active]:bg-card data-[state=active]:text-primary rounded-md transition-all text-xs sm:text-sm">
                Location Scorecard
              </TabsTrigger>
              <TabsTrigger value="pitch" className="font-serif font-bold py-2.5 data-[state=active]:bg-card data-[state=active]:text-primary rounded-md transition-all text-xs sm:text-sm">
                Pitch Script Helper
              </TabsTrigger>
              <TabsTrigger value="inspection" className="font-serif font-bold py-2.5 data-[state=active]:bg-card data-[state=active]:text-primary rounded-md transition-all text-xs sm:text-sm">
